             ...
             <ul className=" bg-white w-216 h-30 rounded-lg">
                 <div className="text-center flex justify-evenly w-full h-full text-4xl items-center  ">
                     ...
                     <div className="   w-20 h-10 mr-3 rounded-4xl  shadow-2xl ">
                         <button className=" flex  bg-sky-200  hover:cursor-pointer justify-center items-center w-20 rounded-4xl text-black h-10  text-center hover:bg-sky-500 hover:text-white "
